...
function updateTotalPrice() {
	...
	const accessoriesPrice = parseInt(accessoriesPriceElement.textContent.replace(/\s/g, ''))
...
if (savedData) {
	...
	inputFinanceType = document.querySelector(`input[name="finance"][value="${financeType}"]`)
	if (inputFinanceType) {
...
function submitFormOrder() {
	...
	//   popup
	showOrderPanel(car, inputName, inputSurname, inputAddress, inputZip, inputCity, date)
}

function showOrderPanel(car, inputName, inputSurname, inputAddress, inputZip, inputCity, date) {
